...
def handle_chats():
    match request.method:
        case "GET":
            ...
            return chat_service.handle_get_list_chats(is_detail=is_detail)
        case "PUT":
            return chat_service.handle_put_chats(request.get_json())
...
def handle_chat_by_id(id: str):
    match request.method:
        case "GET":
            ...
            return chat_service.handle_get_chat(id, is_detail=is_detail)
        case "DELETE":
            return chat_service.handle_delete_chat(id)
...
def handle_chat_messages(id: str):
    match request.method:
        case "GET":
            return http_errors.not_implemented()
        case "PUT":
            return chat_service.handle_put_chat_message(
                chat_id=id,
